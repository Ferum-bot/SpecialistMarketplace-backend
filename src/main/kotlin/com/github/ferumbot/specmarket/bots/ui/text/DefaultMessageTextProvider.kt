...
class DefaultMessageTextProvider: MessageTextProvider {
    ...
    override fun provideStartScreenMessage(): String {
        return StringBuilder()
            .append("Доброго времени суток. Ты находишься на главном экране.\n")
            .append("\n")
            .append("Этот бот поможет тебе найти специалиста из сферы информационного и медиа бизнеса для любого твоего проекта.\n")
            .append("Мы предоставляем большую биржу специалистов, которых мы лично проверели и убедились в их профессиональном опыте и кейсах.\n")
            .append("Также мы предоставляем возможность специалистам создать свой профиль. Мы его проверим и дадим несколько советов как его можно улучшить.\n")
            .append("Для навигации по боту ты можешь использовать кнопки под сообщениями и в клавиатуре. Так же всегда доступны несколько команд:")
            .append("\"Назад\", \"На главную\" и \"Связаться с нами\". Ты их можешь выбрать из меню снизу.\n")
            .append("Для того, чтобы начать работать с нашим ботов, выбери кем ты являешься и следуй инструкциям из сообщений.\n\n")
            .append("Если ты хочешь найти специалиста то, нажимай \"Я заказчик\".\n")
            .append("Если ты хочешь выложить свое резюме на нашу биржу то, нажимай \"Я специалист\".\n")
            .append("Так же ты всегда можешь посмотреть на всех доступных специалистов. Просто нажми \"Все специалисты\".\n")
            .append("Чтобы посмотреть свой профиль специалиста или посмотреть свои обращения, нажми \"Мой профиль\".\n")
            .append("Если хочешь с нами связаться, то нажми \"Связь с нами\".")
            .toString()
    }
    ...
    override fun provideIAmCustomerInfoMessage(): String {
        return StringBuilder()
            .append("Наш сервис предоставляет несколько возможностей для поиска специалистов.\n")
            .append("Если вы знаете, кто вам нужен, вы всегда можете воспользоваться нашей биржей специалистов.\n")
            .append("Вы можете отфильтровать по нужным для вас профессиям и актуальным нишам.\n")
            .append("Мы сохраним все ваши обращения, так что вы всегда сможете вернуться к ним на экране профиля!\n\n")
            .append("Если вы не знаете, кто вам нужен, то вы можете воспользоваться нашей справкой, либо заказать услугу подбора спецаилостов.\n")
            .append("Мы подберем вам релеватных специалостов, проведем собеседования и проверим по вашему тз.")
            .toString()
    }
